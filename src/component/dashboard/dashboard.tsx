  ...
  return (
    <>
      <div className="relative flex flex-col h-screen w-screen bg-gray-900">
        ...
        <nav className="flex justify-between items-center w-full h-16 pl-5 my-5">
          <section>
            <div className="flex justify-center w-56 py-1 px-3 rounded-3xl bg-stone-200 text-black">
              <input
                type="text"
          ...
          <section>
            <div
              ref={userProfileRef}
              className="relative flex items-center pr-5 text-white"
            >
              <img
        ...
        <section className="relative flex justify-between h-full w-full">
          <section className="flex max-w-6xl">Test</section>

          <section className="flex">
            <aside
              id="Sidebar"
              className="flex justify-center h-full w-60 rounded-2xl mr-5 bg-gray-950 text-gray-200"
            >
              <div className="font-roberto">
                <section className="flex flex-col items-center">
                  <p className="my-5 text-2xl">{shopName}</p>
