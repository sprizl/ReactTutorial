...
const Dashboard: React.FC = () => {
  ...
  return (
    <>
      <div className="h-screen w-screen flex relative bg-gray-900">
        <aside
          id="Sidebar"
          className="h-full w-60 text-center rounded-tr-2xl rounded-br-2xl bg-gray-950 text-gray-200"
        >
          <div className="flex flex-col font-roberto">
        ...
        <nav className="flex justify-between w-full h-16 pl-5 my-5">
          <section>
            <div className="flex items-center justify-center w-56 py-1 px-3 rounded-3xl bg-stone-200 text-black">
              <input
                type="text"
          ...
          <section>
            <div className="pr-2 text-white">{fon.GetFullName()}</div>
          </section>
        </nav>
      </div>
    </>
